  ...
  const loadLeaderboards = async () => {
    ...
    try {
      const [dailyData, eloData] = await Promise.all([
        ...
        cloudSyncService.getEloLeaderboard(50)
      ]);
        ...
        <div className="bg-[#18181B] border border-zinc-800 rounded-2xl p-5 shadow-card-subtle space-y-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-zinc-400 mt-0.5">
                Clasificación de jugadores según sus victorias y puntos de Elo en duelos.
              </p>
            </div>
            <span className="text-xs font-mono bg-cyan-950/60 text-cyan-300 px-3 py-1 rounded-lg border border-cyan-800/60 font-bold">
              Liga Competitiva
            </span>
          </div>
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="flex items-center gap-2">
                          <span className={`text-xs font-bold ${isCurrentPlayer ? 'text-cyan-300' : 'text-zinc-200'}`}>
                            {player.nickname}
                          </span>
                          {isCurrentPlayer && (
                            <span className="text-[10px] bg-cyan-950 text-cyan-300 px-2 py-0.2 rounded border border-cyan-800 font-bold">
                              Tu perfil
                            </span>
                          )}
                        </div>
                    ...
                    <div className="text-right">
                      <span className="text-cyan-400 font-bold text-sm sm:text-base block">
                        {player.elo} Elo
                      </span>
                    </div>
                  </div>
