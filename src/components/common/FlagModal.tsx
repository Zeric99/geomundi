...
import { X, ZoomIn, Globe, Landmark, Users, MapPin } from 'lucide-react';
    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 select-none">
        ...
        <motion.div
          ...
          className="relative z-10 w-full max-w-2xl bg-gradient-to-b from-[#131C2E] via-[#0F172A] to-[#0B1120] border border-cyan-500/40 rounded-3xl p-6 sm:p-8 shadow-[0_0_50px_rgba(6,182,212,0.3)] overflow-hidden space-y-6"
        >
          ...
          {/* Cabecera con Nombre y Bandera Emoji */}
          ...
          <div className="relative w-full aspect-[3/2] max-h-[340px] rounded-2xl overflow-hidden shadow-2xl border-2 border-slate-700 bg-slate-950/80 flex items-center justify-center group">
            <img
              src={country.flagSvg}
              alt={`Bandera oficial de ${country.nameEs}`}
              className="w-full h-full object-contain drop-shadow-[0_8px_20px_rgba(0,0,0,0.6)] transition-transform duration-300 group-hover:scale-105"
            />
          ...
          <div className="text-center pt-1">
            <span className="text-xs text-slate-400">
              Pulsa en cualquier lugar o presiona <kbd className="px-1.5 py-0.5 rounded bg-slate-800 border border-slate-700 text-slate-300 font-mono text-[11px]">Esc</kbd> para cerrar.
            </span>
          </div>
        </motion.div>
      </div>
