...
export const GameFilters: React.FC<GameFiltersProps> = ({
  ...
  return (
    <div className="relative w-full max-w-6xl mx-auto space-y-6 overflow-visible animate-in fade-in duration-200">
      {/* MASTER HERO: Desafío Mundial del Día + Partida Rápida 1-Click */}
      ...
      {/* Grid Principal de Tarjetas de Modos de Juego (Clásica) */}
      ...
      <div className="relative z-10 bg-[#18181B] border border-indigo-500/30 rounded-2xl p-4 sm:p-5 flex items-center justify-between gap-4 flex-wrap shadow-sm">
        ...
        <button
          onClick={onGoToTutor}
          className="px-4 py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-bold text-xs shadow-sm transition-all flex items-center gap-2 active:scale-95 border border-indigo-500 cursor-pointer"
        >
