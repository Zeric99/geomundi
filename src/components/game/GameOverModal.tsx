  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/75 backdrop-blur-md animate-in fade-in duration-200">
      <div className="bg-[#18181B] border border-zinc-800 rounded-2xl p-6 sm:p-8 max-w-lg w-full shadow-2xl relative overflow-hidden animate-in zoom-in-95 duration-200 space-y-5">
        ...
        {/* Banner de Invitación a Guardar Progreso / Registrarse si no está logueado */}
        {!user && (
          <div className="bg-gradient-to-r from-indigo-950/80 via-zinc-900 to-cyan-950/80 border border-indigo-500/40 rounded-2xl p-3.5 text-left shadow-lg relative overflow-hidden space-y-2.5">
            <div className="flex items-start gap-2.5">
              ...
              <div>
                <h4 className="font-bold text-xs sm:text-sm text-zinc-100">
                  ¿Quieres guardar tu puntuación y récords?
                </h4>
                <p className="text-[11px] text-zinc-300 leading-snug mt-0.5">
                  Inicia sesión gratis para guardar tus logros en la nube y desbloquear el Modo Multijugador ⚔️.
                </p>
              </div>
            </div>
            ...
            <button
              ...
              className="w-full py-2 px-3 bg-white hover:bg-zinc-100 text-zinc-900 font-bold text-xs rounded-xl shadow-md transition-all flex items-center justify-center gap-2 active:scale-95 cursor-pointer"
            >
              ...
              <span>Guardar mi Progreso con Google</span>
            </button>
          </div>
        )}
